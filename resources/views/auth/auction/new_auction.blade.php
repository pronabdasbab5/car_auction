      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ url('newauction') }}" class="form-horizontal form-label-left">
                @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="text" name="auction_group_name" id="auction_group_name"  class="form-control col-md-7 col-xs-12 text-bold" placeholder="Enter Auction Group Name" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="date" name="auction_start_date" id="auction_start_date"  class="form-control col-md-7 col-xs-12 text-bold" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="date" name="auction_end_date" id="auction_end_date"  class="form-control col-md-7 col-xs-12 text-bold" required>
              ...
              <div class="ln_solid"></div>
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <button type="submit" name="submit" class="btn btn-success text-bold">Create Auction Group Name</button>
                  </div>
                </div>
            </form>
